#
# Be sure to run `pod lib lint WMPageController-JQHover.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WMPageController-JQHover'
  s.version          = '0.1.0'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'WMPageController-JQHover/Classes/**/*'
  
  # s.resource_bundles = {
  #   'WMPageController-JQHover' => ['WMPageController-JQHover/Assets/*.png']
  # }
